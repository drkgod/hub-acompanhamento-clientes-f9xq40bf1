routerAdd(
  ...
  (e) => {
    ...
    const meetings = $app.findRecordsByFilter('meetings', `user_id = '${userId}'`, '-data', 1000, 0)
    ...
    return e.json(200, { success: true, digest: result.content, id: record.id })
  },
  $apis.requireAuth(),
)
