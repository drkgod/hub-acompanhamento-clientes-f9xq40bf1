...
export function Card({ client, index }: { client: Client; index: number }) {
  ...
  return (
    <div
      ...
      className={cn(
        'group flex flex-col p-4 bg-white rounded-lg border border-slate-200 shadow-sm cursor-grab active:cursor-grabbing hover:shadow-md hover:border-slate-300 transition-all duration-200 animate-in fade-in zoom-in-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500',
