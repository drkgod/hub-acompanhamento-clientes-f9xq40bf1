        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            >
              <AccordionTrigger className="px-4 py-5 hover:no-underline font-bold text-slate-800 text-lg">
                <div className="flex items-center gap-3">
                  <TrendingUp className="h-6 w-6 text-rose-500 bg-rose-50 p-1 rounded-md" /> Pontos
                  de Melhoria
                </div>
              </AccordionTrigger>
              <AccordionContent className="px-4 pb-5">
        ...
        <div className="space-y-6">
          <div className="bg-white border rounded-2xl p-6 shadow-sm sticky top-6">
            <h3 className="font-bold text-lg text-slate-800 mb-6 flex items-center gap-3">
              <MapIcon className="h-6 w-6 text-emerald-500 bg-emerald-50 p-1 rounded-md" /> Roadmap
              do Cliente
            </h3>
